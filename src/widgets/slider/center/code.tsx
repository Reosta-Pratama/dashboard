...
interface CodeSliderCenterProps {
    active: boolean;
}

export const CodeSliderCenter: React.FC<CodeSliderCenterProps> = ({active}) => {
    ...
    disabled">
        ...
        <div class="keen-slider">
            <div
                ...
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(169.55px, 0px, 0px);">
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(185.55px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(201.55px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(217.55px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(233.55px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 153.55px; max-width: 153.55px; transform: translate3d(249.55px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
