...
export const CodeSliderSingle: React.FC<CodeSliderSingleProps> = ({active}) => {
    ...
    <div class="relative flex justify-center items-center gap-4">
        ...
        <div class="keen-slider">
            <div
                ...
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(0px, 0px, 0px);">
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(16px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(32px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(48px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(64px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
            ...
            <div
                class="keen-slider__slide h-32 transition-opacity ease-in-out"
                style="opacity: 1; min-width: 492.65px; max-width: 492.65px; transform: translate3d(80px, 0px, 0px);">
                <div class="w-full h-full">
                    <h3
