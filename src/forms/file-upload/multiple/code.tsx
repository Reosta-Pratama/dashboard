...
interface CodeFileUploadMultipleProps {
    active: boolean;
}

export const CodeFileUploadMultiple: React.FC<CodeFileUploadMultipleProps> = ({active}) => {
...
<div class="flex flex-col gap-2">
    <div
        ...
        <input type="file" id="file-upload-1" class="hidden" multiple name="file-upload-2">
