...
export const Blog: React.FC<BlogProps> = ({index, cover, title, desc, categories, authors, totalComments, totalLikes, totalViews}) => {
    return (
            ...
            <div className="relative rounded-t-[.6rem] overflow-hidden">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col flex-1 gap-[2px] text-white">
                                        ...
                                        <span className='text-xs'>
                                            ...
                                            <DateFormat value={item.createdAt}></DateFormat>
                                        </span>
                                    </div>
                                </div>
                            ))
                ...
                <div className="absolute z-[2] bottom-6 left-0 w-full px-5">
                    <div className="flex flex-col gap-3 text-white">
                        <ul className='w-fit bg-white/20 flex gap-1
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex justify-between items-center px-5">
                        <div className="flex items-center gap-2">
                            <span>
                                ...
                                <strong className='font-medium'>
                                    <NumberFormat value={totalComments}></NumberFormat>
                                </strong>
                            </span>
                            <span>
                                Views:
                                <strong className='font-medium'>
                                    <NumberFormat value={totalViews}></NumberFormat>
                                </strong>
                            </span>
                        </div>
                        ...
                        <span>
                            Likes:
                            <strong className='font-medium'>
                                <NumberFormat value={totalLikes}></NumberFormat>
                            </strong>
                        </span>
                    </div>
