...
import { Tooltip } from '../basic/components/box';
import { ValueTooltip } from '../basic/components/value';

interface CodeClickTooltipProps {
    active: boolean;
}

export const CodeClickTooltip: React.FC<CodeClickTooltipProps> = ({active}) => {
